...
try:
    ...
    VRCClient = None # Allow running without VRCClient for testing dispatcher logic
...
class OutputDispatcher:
    ...
    def __init__(self, vrc_client_instance: Optional[VRCClient] = None):
            ...
            try:
                ...
                for i, result in enumerate(results):
                   if isinstance(result, Exception):
                       ...
                       logger.error(f"OutputDispatcher: Error in dispatch task ({task_name}): {result}", exc_info=result)
